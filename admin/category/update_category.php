            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="page-category">
                        ...
                        <form action="?act=post_update_category" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="only" id="only" class="form-control" value="<?= ($category['only'] ?? '') ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="status">Trạng thái:</label>
                                <select name="status" id="status" class="form-control" required>
                                    <option value="1" <?= isset($category['status']) && $category['status'] == 1 ? 'selected' : '' ?>>Hiện</option>
                            ...
                            <div class="form-group">
                                <?php if (!empty($category['image'])) { ?>
                                    <br><img src="<?= ($category['image'])  ?>" alt="Ảnh danh mục" width="100">
                                <?php } ?>
                                <br>
