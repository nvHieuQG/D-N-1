      ...
      <div class="main-panel">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <form action="?act=post_update_voucher&id=<?= $data['voucher_id'] ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="">Tên voucher</label>
                  <input type="text" name="code" id="" class="form-control" placeholder="" aria-describedby="helpId" value="<?=  $data['code'] ?>" >
                  <small id="helpId" class="text-muted">Help text</small>
                </div>
                <div class="form-group">
                  <label for="">% giảm</label>
                  <input type="text" name="discount_percent" id="" class="form-control" placeholder="" aria-describedby="helpId" value="<?= ( $data['discount_percent'] * 100) ?>">
                  <small id="helpId" class="text-muted">Help text</small>
                </div>
                <div class="form-group">
                  <label for="">Số lượng</label>
                  <input type="text" name="quantity" id="" class="form-control" placeholder="" aria-describedby="helpId" value="<?=  $data['quantity'] ?>">
                </div>
                <div class="form-group">
                  <label for="">Giá trị đơn tối thiểu</label>
                  <input type="text" name="minimum" id="" class="form-control" placeholder="" aria-describedby="helpId" value="<?=  $data['minimum'] ?>">
                </div>
